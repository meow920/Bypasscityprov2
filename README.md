...
<div class="container">
    <div class="header">
        ...
        <span class="badge">⚡ v4.0 – 70+ sites + Executor Bypass</span>
    ...
    <div id="tab-bypass" class="tab-content active">
        <div class="card">
            <h2>🌐 Unlock any short link – fast, clean, no ads</h2>
            ...
            <div class="loader" id="loader">
                ...
                <p>Resolving final URL…</p>
            </div>

            <div id="result">
                <div class="final-url" id="finalUrlDisplay">
                    <span>🔗 Final URL: </span><a href="#" target="_blank" id="finalLink">Click to open</a>
                </div>
            </div>
        </div>
...
<script>
    (function() {
        ...
        function bypass(url) {
            ...
            // We'll use https://corsproxy.io/ as a free proxy
            ...
            .then(response => {
                ...
                if (finalUrl === proxyUrl) {
                    // Did not redirect; maybe the proxy itself is blocked.
                    // Try alternative method: fetch the target directly with no-cors? Not possible.
                    // We'll assume it's the final destination.
                    return target;
                }
                return finalUrl;
            })
            ...
            .catch(err => {
                ...
                finalLink.textContent = target + ' (could not resolve – opening original)';
                showToast('⚠️ Could not resolve – try again or use a different proxy.', 3000);
                bypassBtn.disabled = false;
            });
        }
